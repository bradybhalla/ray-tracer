  ...
  Scene.create
    ...
    ~primitives:
      [
        ...
        sphere_light_at (Vec3.create 0.0 (-5.0) 0.0) 3.0 10.0;
      ]
    ~external_lights:[ Infinite (Uniform (Vec3.create 0.2 0.2 0.2)) ]
...
let spheres_scene pixel_height t =
  ...
  Scene.create
    ...
    ~external_lights:[ point_light_at (Vec3.create (-10.0) (-30.0) (-30.0)) 2000.0 ]
...
let room_scene pixel_height t =
  ...
  Scene.create
    ...
    ~primitives:[
        ...
        sphere_light_at (Vec3.create 0.0 (-1.0) 0.0) 1.0 10.0
      ]
    ~external_lights:[]
...
let obj_scene pixel_height =
  ...
  fun t ->
    ...
    Scene.create
      ~camera:(Camera.create ~pos:(Vec3.create 0.0 (-2.0) (-10.0)) ~pixel_height ())
      ~primitives:(List.map
          (fun triangle ->
            Primitive.
              {
      ...
      ~external_lights:[ point_light_at (Vec3.create (-18.0) (-10.0) (-20.0)) 500.0 ];
